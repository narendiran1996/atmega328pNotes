...
{
	PORTC = (PORTC & 0b11000011) | ((val_ & 0xF0)>>2); // selecting PC5 - PC2 as LCD[7:4] and sending MSB
}
void LCD_set_LSB(uint8_t val_)
{
	PORTC = (PORTC & 0b11000011) | ((val_ & 0x0F)<<2);  // selecting PC5 - PC2 as LCD[7:4] and sending LSB
}
